...
def get_args():
    ...
    parser.add_argument('-c', '--compound_coef', type=int, default=1)

    # Output customization
    parser.add_argument('--output_name', type=str, default='pianika_d1_batch9',
    ...
    parser.add_argument('-w', '--load_weights', type=str, 
                       default='weights/efficientdet-d1.pth')
